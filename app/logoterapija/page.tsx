  ...
  return (
    <div className="min-h-screen ">
      ...
      <section className=" relative h-[70dvh]">
        <Image src="/logoterapija.jpg" alt="Logoterapija" fill className="object-cover -z-10 [object-position:50%_35%]" />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              <p className=" first-letter:pl-6">
                Logoterapija je terapija smislom. Logoterapija je treća bečka psihoterapijska škola.
                Ona u psihoterapiju unosi nešto novo, a to je spoznaja da je čovek duhovno biće.
              </p>

              <p className=" first-letter:pl-6">
                Osnivač logoterapije je bečki psihijatar i doktor filozofije <span className="font-bold">  Viktor E. Frankl (1905 – 1997) </span>
                poznat kao čovek koji je preživeo strahote koncentracionog logora Terezijaštat, Aušvic, Dahau.
              </p>

              <p className=" first-letter:pl-6">
                Sam termin logoterapija, doslovno znači <span    className="font-bold"> lečenje smislom </span> ili <span className="font-bold"> isceljivanje smislom </span>.
                Logoterapija odgovara na večno čovekovo pitanje: <span className="font-bold"> u čemu je smisao mog života?
              U čemu je smisao trpljenja, smisao stvaranja, smisao našeg postojanja? </span>
              </p>
            </motion.div>
